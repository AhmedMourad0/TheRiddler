...
public class MultiAnswerQuestion implements MultiQuestion<String[]> {
	...
	@NonNull
	public static MultiAnswerQuestion create(final String value, final String[] answer, final String[] wrongAnswers) {
		final MultiAnswerQuestion question = new MultiAnswerQuestion();
	...
	@Override
	public int getType() {
		return Question.TYPE_MULTI_ANSWER;
	}
}
